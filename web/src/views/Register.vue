      ...
      <div class="login">
        ...
        <div class="login-form">
          ...
          >
            ...
            >注册</el-button>
            <p>
              <el-link :underline="false" @click.native="$router.push('/login')">已有账号？去登录</el-link>
            </p>
          </el-form>
        </div>
      </div>
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        rePassword: [
          { required: true, trigger: 'blue', validator: validatePassword2 }
        ]
      },
      loading: false,
...
.login {
  width: 100vw;
  height: 100vh;
  background: url('../assets/register-bg.jpg') center/cover;
  font-size: 14px;
  overflow: hidden;
}
.login-form {
